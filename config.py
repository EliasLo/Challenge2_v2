...
val_size = .3  # could be changed # 0.2 original # instead 0.25
...
model_constructor = "ResNet_3(BasicBlock_2, [1, 2, 2, 2])"
...
epochs = 100 #120 #200 original
patience = 20 # 20 original
lr = 1e-3
weight_decay = 1e-3
warm_epochs = 10
gamma = 0.960   #0.80 original  #instead 0.96
step_size = 5
